...
//service info
svcommLit:      svcommToken=ID '<-' svcommValue=STRING;
...
// eg: type Foo int
typeLit:        atType? {match(p,"type")}typeToken=ID  typeLitBody;
// eg: type (...)
typeBlock:      atType? {match(p,"type")}typeToken=ID lp='(' typeBlockBody* rp=')';
typeLitBody:    typeStruct|typeAlias;
typeBlockBody:  typeBlockStruct|typeBlockAlias;
atType:         ATTYPE lp='('? ((kvLit+)|STRING) rp=')'?;
...
serviceRoute:   atDoc? (atServer|atHandler) atDesc? route;
