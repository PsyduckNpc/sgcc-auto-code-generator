...
type ApiParserVisitor interface {
	...
	// Visit a parse tree produced by ApiParserParser#svcommLit.
	VisitSvcommLit(ctx *SvcommLitContext) interface{}
	...
	// Visit a parse tree produced by ApiParserParser#atType.
	VisitAtType(ctx *AtTypeContext) interface{}
	...
	// Visit a parse tree produced by ApiParserParser#atDesc.
