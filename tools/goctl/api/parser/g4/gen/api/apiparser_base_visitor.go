...
func (v *BaseApiParserVisitor) VisitSvcommLit(ctx *SvcommLitContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseApiParserVisitor) VisitAtType(ctx *AtTypeContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseApiParserVisitor) VisitAtDesc(ctx *AtDescContext) interface{} {
	return v.VisitChildren(ctx)
}
